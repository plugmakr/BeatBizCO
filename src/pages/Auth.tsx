  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1A1F2C]">
      ...
      <div className="flex-1 flex items-start pt-8">
        {/* Left Side Content */}
        <div className="hidden md:flex w-1/2 p-8 flex-col space-y-8">
          <div className="sticky top-8">
            <h2 className="text-3xl font-bold text-white mb-8">
              {isSignUp ? "Why Choose BeatBiz?" : "Latest Updates"}
            </h2>
            <div className="grid gap-6">
              {(isSignUp ? highlights : updates).map((item, index) => (
            ...
            <img
              ...
              alt={isSignUp ? "Music Production" : "Studio Session"}
        ...
        <div className="w-full md:w-1/2 p-4 md:p-8">
          <div className="w-full max-w-md mx-auto sticky top-8">
            <AuthForm />
          </div>
        </div>
      </div>
